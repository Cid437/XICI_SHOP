...
<div class="cart-view-table-back">
    <form method="POST" action="cart_update.php">
        <table width="100%" cellpadding="6" cellspacing="0">
            ...
            <tbody>
                <?php
                // FIX: Initialize $total to 0 before checking the cart.
                $total = 0; 
                
                if (isset($_SESSION["cart_products"])) //check session var
                {
                    // The line "$total = 0;" was originally here. It has been moved up.
                ...
                ?>
                <tr>
                    <!-- This line will now work correctly even if the cart is empty -->
                    <td colspan="5"><span style="float:right;text-align: right;">Amount Payable : <?php echo sprintf("%01.2f", $total); ?></span></td>
                </tr>
                <tr>
                    <td colspan="5"><a href="/XiCiTest1/index.php" class="button">Add More Items</a>
