...
<body>
  <header class="site-header">
    <div class="container">
  <a class="brand" href="/XiCiTest1/item/index.php">Admin</a>
      ...
      <nav class="main-nav" id="main-nav">
        <ul class="nav-list">
          ...
          <li class="has-dropdown">
            <?php if (isset($_SESSION['user_id'])): ?>
              <button class="drop-btn">Menu <i class="fa fa-caret-down"></i></button>
              <ul class="dropdown">
                <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                  <li><a href="/XiCiTest1/item/index.php">Item</a></li>
        ...
        <form action="/XiCiTest1/search.php" method="GET" class="search-form">
        ...
        <div class="auth-links">
          ...
          <?php else: ?>
            ...
            <a class="btn btn-link" href="/XiCiTest1/user/logout.php">Logout</a>
          <?php endif; ?>
        </div>
      </nav>
    </div>
